...
<template>
  <div>
    ...
    <div
      class="mb-2.5 space-y-2 border-b border-white pb-2.5 dark:border-black"
    >
      <CommonSkeleton
    ...
    <div class="space-y-2">
      <CommonSkeleton
        :style="{ 'animation-delay': `${0.7}s` }"
        class="h-4 w-1/2"
      />
      <CommonSkeleton
        :style="{ 'animation-delay': `${0.8}s` }"
        class="h-6 w-full"
      />
      <CommonSkeleton
        :style="{ 'animation-delay': `${0.9}s` }"
        class="h-6 w-full"
      />
      <CommonSkeleton
