...
do
  ...
  echo "  Exporting key informationâ€¦"
  ...
  # Cleanup.
  echo "  Deleting keys from keyringâ€¦"
...
do
  ...
  echo "  Adding UID ${PGP_UIDS[$i]} to the same keyâ€¦"
...
do
  ...
  do
    ...
    echo "    Using $SANITIZED_EMAIL_ADDRESS as recipientâ€¦"
...
do
  ...
  echo "  Constructing signed messageâ€¦"
...
do
  ...
  echo "  Encrypting + signing message in one commandâ€¦"
