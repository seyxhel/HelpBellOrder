...
class App.UiElement.object_selector extends App.UiElement.ApplicationSelectorExpert
  @defaults: (attribute = {}, params = {}) =>
    ...
    operators_type =
      ...
      'integer$': [__('is'), __('is not'), __('is less than'), __('is less equal than'), __('is greater than'), __('is greater equal than')]
    ...
    if attribute.hasChanged
      operators_type =
        ...
        'integer$': [__('is'), __('is not'), __('has changed'), __('is less than'), __('is less equal than'), __('is greater than'), __('is greater equal than')]
